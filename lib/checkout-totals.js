...
const { buildCatalogMap, isProductOnline } = require("./product-catalog");
const { isWithinSchedule } = require("./schedule-utils");
...
function applyGlobalPricing(basePrice, globalPricing = {}) {
  ...
  if (!isWithinSchedule(globalPricing)) return numericBase;
